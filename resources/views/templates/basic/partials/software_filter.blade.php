...
<div class="col-xl-12 col-lg-12 mb-30">
    <div class="sidebar">
        ...
        <form action="{{route('software.search.filter')}}" method="GET">
            ...
            <div class="widget mb-30">
                ...
                <div class="form-group custom-check-group">
                    ...
                    <label for="24.'s'">@lang('24 HOURS')</label>
                </div>
        
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="3.'s'" name="level[]" value="3day" class="userLevel">
                    <label for="3.'s'">@lang('3 DAYS')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="1.'s'" name="level[]" value="1w" class="userLevel">
                    <label for="1.'s'">@lang('1 WEEK')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="any" name="level[]" value="any" class="userLevel">
                    <label for="any">@lang('ANY')</label>
                </div>
        
            </div>
        
            <div class="widget mb-30">
                <h3 class="widget-title">@lang('PRODUCT RATING')</h3>
        
        
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="95" name="level[]" value="95" class="userLevel">
                    <label for="95">@lang('5.00 Stars')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="90" name="level[]" value="1w" class="userLevel">
                    <label for="90">@lang('4.00 Stars')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="1.'s'" name="level[]" value="1w" class="userLevel">
                    <label for="1.'s'">@lang('3.00 Stars')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="any" name="level[]" value="any" class="userLevel">
                    <label for="any">@lang('2.00 Stars')</label>
                </div>
                                <div class="form-group custom-check-group">
                    <input type="checkbox" id="any" name="level[]" value="any" class="userLevel">
                    <label for="22.'s'">@lang('1.00 Stars')</label>
                </div>
        ...
        <div class="widget mb-30">
            <h3 class="widget-title">@lang('TRENDING PRODUCTS')</h3>
        ...
        <div class="widget-btn text-center mb-30">
            @if($fservices->total() > 2)
                <a href="{{ route('software.search') }}" class="btn--base readMore" data-page="2" data-link="{{route('home')}}?page=">@lang('Show More')</a>
            @endif
        </div>
