<div class="col-xl-12 col-lg-12 mb-30">
    <div class="sidebar">
        ...
        <form action="{{route('job.filter.search')}}" method="GET">
            ...
            <div class="widget mb-30">
                ...
                <div class="form-group custom-check-group">
                    ...
                    <label for="95">@lang('4.00 Stars')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="1.'s'" name="level[]" value="1w" class="userLevel">
                    <label for="95">@lang('3.00 Stars')</label>
                </div>
                <div class="form-group custom-check-group">
                    <input type="checkbox" id="any" name="level[]" value="any" class="userLevel">
                    <label for="95">@lang('2.00 Stars')</label>
                </div>
                                <div class="form-group custom-check-group">
                    <input type="checkbox" id="any" name="level[]" value="any" class="userLevel">
                    <label for="95">@lang('1.00 Stars')</label>
                </div>
        ...
        <div class="widget mb-30">
            <h3 class="widget-title">@lang('AVAILABLE JOBS')</h3>
        ...
        <div class="widget-btn text-center mb-30">
            @if($fservices->total() > 4)
                <a href="{{ route('job.search') }}" class="btn--base readMore" data-page="2" data-link="{{route('home')}}?page=">@lang('Show More')</a>
            @endif
        </div>
