                                                    ...
                                                    <div class="item-details-content">
                                                        ...
                                                        <div class="item-details-footer mb-20-none">
                                                            ...
                                                            @if ($software->product_type == 2)
                                                                @if(isset($software->demo_url) && !empty($software->demo_url))
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <ul class="details-list">
                                                                                ...
                                                                                <li><span>@lang('Product Price')</span>
                                                                                    <span>{{ $code['currency'] }}{{ number_format($software->amount* $code['rate'], 2, '.', '') }}
                                                                                        </span>
                                                                                </li>
                                                                                <li><span>@lang('Shipping Charge')</span>
                                                                                    <span>{{ $code['currency'] }}{{ number_format($software->shipping_charge* $code['rate'], 2, '.', '') }}
                                                                                        </span>
                                                                                </li>
                                                                                <li><span>@lang('Recommandation of selling price')</span>
                                                                                    <input type="hidden" value="{{ $software->shipping_charge + $software->amount }}" id="total_price_d">
                                                                                    <span>{{ $code['currency'] }}{{ $software->shipping_charge + $software->amount* $code['rate'] }}
                                                                                        -
                                                                                        {{ $code['currency'] }}{{ number_format($software->recommand_seling_price* $code['rate'], 2, '.', '') }}
                                                                                        </span>
                                                                                </li>
                                    ...
                                    <div class="col-xl-3 col-lg-3 mb-30">
                                        <div class="sidebar">
                                                    ...
                                                    <li><span>@lang('Product Price')</span>
                                                        <span>
                                                            {{ $code['currency'] }}{{ getAmount($software->amount * $code['rate']) }}
                                                                                                        ...
                                                                                                        <li><span>@lang('Shipping Charge')</span>
                                                        <span>
                                                            {{ $code['currency'] }}{{ number_format($software->shipping_charge* $code['rate'], 2, '.', '') }}
                                                        </span>
                                                    </li>
                                                </ul>
                                                <div class="widget-btn mt-20">
                                                    <a href="{{ route('user.software.buy', [slug($software->title), encrypt($software->id)]) }}"
                                                        class="btn--base w-100">@lang('Buy Now')
                                                        {{ $code['currency'] }}{{ showAmount(($software->amount + $software->shipping_charge) * $code['rate']) }}
                                                    </a>
                                                </div>
                                            ...
                                            <div class="widget custom-widget mb-30">
                                                ...
                                                <ul class="details-list">
                                                    <li><span>@lang('Delivery Time')</span> <span>{{ $software->delivery_day }} @lang('Days')</span></li>
                                                    @php
                                                       $country = explode(',', $software->available_in_country);
                                                    @endphp
                                                    <li><span>@lang('Country')</span><span >@foreach ($country as $cont){{ $cont }}</span>@endforeach</li>
                                                </ul>
                                                ...
                                                <div class="profile-widget">
                                                    <div class="profile-widget-header">
                                                        <div class="profile-widget-thumb">
                                                            @if (isset($software->user->id) && $software->user->id > 0)
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#selling_price").change(function() {
                ...
                let profites = ( $('#selling_price').val() - $('#total_price_d').val() ) * qty;
                profites = parseFloat(profites);
                if (!isNaN(profites)) {
                    profites = profites.toFixed(2);
                }
