                        ...
                        <div class="row mb-10">
                            <div class="col-lg-6 col-sm-6">
                                <h2 class="page-title" style="font-size: 1.125rem;
                                        display: inline-block;">@lang('Purchases')</h2> >@lang('Product Buyer')
                            </div>
                            <div class="col-xl-6">
                                <ul class="nav nav-pills nav-fill"
                                    style="padding: 10px 10px 10px 10px; border: 1px solid; border-radius: 5px;">
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('user.buyer.hire.employ') || request()->routeIs('user.buyer.hire.employ.details') ? 'active' : '' }}" href="{{ route('user.buyer.hire.employ') }}">@lang('Staff List')</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('user.buyer.service.booked') || request()->routeIs('booked.service.details') ? 'active' : '' }}" href="{{ route('user.buyer.service.booked') }}">@lang('Reserved Services')</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('user.software.purchases') ? 'active' : '' }}" href="{{ route('user.software.purchases') }}">@lang('Product Buyer')</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
