                                    ...
                                    <div class="item-details-area">
                                        ...
                                        <div class="product-tab mt-40">
                                            ...
                                            <div class="tab-pane fade" id="bids" role="tabpanel" aria-labelledby="bids-tab">
                                            	@if(auth()->check())
                                                @if(($job->user_id != auth()->user()->id) && ($job->status==1))
                                                                ...
                                                                <div class="item-card-content">
                                                                        <div class="item-card-content-top">
                                                                            <div class="item-top-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                                                                ...
                                                                                <div class="right">
                                                                                    <div class="item-amount">{{ $code['currency'] }}{{showAmount($biding->price* $code['rate'])}}</div>
                                                                                </div>
                                                                            </div>
                                    ...
                                    <div class="sidebar">
                                        <div class="widget custom-widget mb-30">
                                            ...
                                            <ul class="details-list">
                                                ...
                                                <li><span>@lang('Budget')</span> <span>{{showAmount($job->amount* $code['rate'])}} {{ $code['currency'] }}</span></li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="item-card">
                                                    ...
                                                    <div class="item-card-content">
                                                        <div class="item-card-content-top">
                                                            ...
                                                            <div class="right">
                                                                <div class="item-amount">{{ $code['currency'] }}{{getAmount($other->price* $code['rate'])}}</div>
                                                            </div>
                                                        </div>
