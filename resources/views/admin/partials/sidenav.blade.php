...
<div class="sidebar {{ sidebarVariation()['selector'] }} {{ sidebarVariation()['sidebar'] }} {{ @sidebarVariation()['overlay'] }} {{ @sidebarVariation()['opacity'] }}"
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @if (in_array('3', $staffAccess))
                    <li class="sidebar-menu-item  sidebar-dropdown ">
                        <a href="javascript:void(0)" class="{{ menuActive('admin.sales.software*',3) }}"
                            data-default-url="{{ route('admin.sales.software.index') }}">
                            <i class="menu-icon las la-shopping-cart"></i>
                            <span class="menu-title">@lang('Sales Product')</span>
                        </a>
                        <div class="sidebar-submenu {{ menuActive('admin.sales.software*', 2) }} ">
                            <ul>
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.sales.software.pending') }} ">
                                    <a href="{{ route('admin.sales.software.pending') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Pending')</span>
                                    </a>
                                </li>

                                <li class="sidebar-menu-item {{ menuActive('admin.sales.software.shipping') }} ">
                                    <a href="{{ route('admin.sales.software.shipping') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.sales.software.completed') }} ">
                                    <a href="{{ route('admin.sales.software.completed') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Completed')</span>
                                    </a>
                                </li>

                                <li class="sidebar-menu-item {{ menuActive('admin.sales.software.rejected') }} ">
                                    <a href="{{ route('admin.sales.software.rejected') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Rejected')</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item {{ menuActive('admin.sales.software.admin') }} ">
                                    <a href="{{ route('admin.sales.software.admin') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Admin product sales')</span>
                                    </a>
                                </li>
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu {{ menuActive('admin.software*', 2) }} ">
                            <ul>
                                ...
                                <li class="sidebar-menu-item {{ menuActive('admin.software.indexadmin') }} ">
                                    <a href="{{ route('admin.software.indexadmin') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Admin Product')</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
 ...
 @if (in_array('35', $staffAccess))
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.staff*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item  {{ menuActive('admin.reward.index') }}">
                                <a href="{{ route('admin.reward.index') }}" class="nav-link" data-default-url="{{ route('admin.reward.index') }}">
                                    <i class="menu-icon fas fa-wrench"></i>
                                    <span class="menu-title">@lang('Setup Reward') </span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.reward.review') }} ">
                                <a href="{{ route('admin.reward.review') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.chat*', 2) }} ">
                        <ul>

                            <li class="sidebar-menu-item {{ menuActive('admin.chat') }} ">
                                <a href="{{ route('admin.chat') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">All Chat</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item  ">
                                <a href="" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"> Pending Chat</span>
                            ...
                            <li class="sidebar-menu-item  ">
                                <a href="" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">Answered Chat</span>
                                </a>
                            </li>
                        </ul>
                    </div>
